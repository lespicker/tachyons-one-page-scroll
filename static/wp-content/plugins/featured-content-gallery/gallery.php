<div id="featured">
	...
	$blankimg =  get_bloginfo('wpurl')."/wp-content/plugins/featured-content-gallery/blank.gif";
				 ...
				 <div class="imageElement">
					 ...
					 <?php 
					  ...
					  <?php
						...
						$image = (get_post_meta($post->ID, "articleimg", true)) ? get_post_meta($post->ID, "articleimg", true) : $blankimg;
						$thumbnail = (get_post_meta($post->ID, $imgthumb, true)) ? get_post_meta($post->ID, $imgthumb, true) : $blankimg;
						?>
					  <a href="<?php the_permalink() ?>" title="Read More" class="open"></a>
					  <img src="<?php echo $image; ?>" alt="<?php echo get_post_meta($post->ID, "alttext", true); ?>" class="full" />
					  <img src="<?php echo $thumbnail ?>" alt="<?phpecho get_post_meta($post->ID, "alttext", true); ?>" class="thumbnail" />
				  </div>
			 <?php 
			 } ?>
		 </div>
		...
		<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		   <div class="imageElement">
			 ...
			 <?php 
					  ...
					  <a href="<?php the_permalink() ?>" title="Read More" class="open"></a>
					  <img src="<?php echo $image; ?>" alt="<?php echo get_post_meta($post->ID, "alttext", true); ?>" class="full" />
					  <img src="<?php echo $thumbnail ?>" alt="<?php echo get_post_meta($post->ID, "alttext", true); ?>" class="thumbnail" />
		  </div>
		  <?php endwhile; else: ?>
		  <?php endif; ?>
