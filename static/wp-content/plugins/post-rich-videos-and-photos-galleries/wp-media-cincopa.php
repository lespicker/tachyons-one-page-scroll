...
';
	...
	$ret .= "<div id='_prewig_".$uni."'>Cincopa <a href='http://www.cincopa.com/wpplugin/wordpress-plugin.aspx'>wp content plugins</a> solution for your website. Use Cincopa MediaSend for <a href='http://www.cincopa.com/mediasend/start.aspx'>file transfer</a>.</div>";
	$ret .= "<script type='text/javascript'>document.getElementById('_prewig_".$uni."').innerHTML='';</script>
";
