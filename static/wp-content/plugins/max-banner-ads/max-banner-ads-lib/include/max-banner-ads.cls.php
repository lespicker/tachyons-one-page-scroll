...
class MBPBannerAds
{
	...
	function __mbanHeader() {
		...
		echo '<br /><strong>'.$this->img_how.' <a href="http://www.maxblogpress.com/plugins/mba/mba-use/" target="_blank">How to use it?</a></strong>&nbsp;&nbsp;&nbsp;';
		echo '<strong>'.$this->img_comment.' <a href="http://www.maxblogpress.com/plugins/mba/mba-comments/" target="_blank">Comments and Suggestions</a></strong>&nbsp;&nbsp;&nbsp;';
	...
	function __mbanRegistrationForm($form_name, $submit_btn_txt='Register', $name, $email, $hide=0, $submit_again='') {
		...
		<form name="<?php echo $form_name;?>" method="post" action="http://www.aweber.com/scripts/addlead.pl" <?php if($submit_again!=1){;?>onsubmit="return __mbanValidateForm_0()"<?php }?>>
		 ...
		 <input type="hidden" name="meta_adtracking" value="mba-m-activate">
	...
	function __mbanRegisterStep1($form_name='frm1',$userdata) {
		...
		<div class="wrap"><h2> <?php echo MBAN_NAME.' '.MBAN_VERSION; ?></h2>
		 ...
		 <table width="100%" cellpadding="3" cellspacing="1" style="border:2px solid #e3e3e3; padding: 8px; background-color:#f1f1f1;">
		  <tr><td align="center">
		    <table width="540" align="center" cellpadding="3" cellspacing="1" style="border:1px solid #e9e9e9; padding: 8px; background-color:#ffffff;">
			  ...
			  <tr><td align="center"><font size="1">[ Your contact information will be handled with the strictest confidence <br />and will never be sold or shared with third parties.Also, you can unsubscribe at anytime.]</font></td></tr>
		    </table>
		  </td></tr></table>
		 </center>
		<p style="text-align:center;margin-top:3em;"><strong><?php echo MBAN_NAME.' '.MBAN_VERSION; ?> by <a href="http://www.maxblogpress.com/" target="_blank" >MaxBlogPress</a></strong></p>
