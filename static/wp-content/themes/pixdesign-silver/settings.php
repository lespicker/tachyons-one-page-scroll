...
$themename = "PixDesign Theme";
$shortname = "slickpress";
$options = array (
	...
	array(  "name" => "Youtube Video ID",
            ...
            "type" => "text",
			"note" => "<strong>Example: </strong> http://www.youtube.com/watch?v=<strong style='color: #ff0000;'>OALrSNN9HJk</strong>"),
			
/*	array(	"name" => "Gravatars",
            "id" => $shortname."_gravatar",
            "std" => $settings['gravatar'],
            "type" => "select",
			"options" => array(0=>'enabled', 1=>'disabled')),*/
			
	array(  "name" => "Gravatar Fallback",
            "id" => $shortname."_gravatar_fallback",
            "std" => $settings['gravatar_fallback'],
            "type" => "text",
			"note" => "<strong>Example: </strong> monsterid, identicon, etc."),
