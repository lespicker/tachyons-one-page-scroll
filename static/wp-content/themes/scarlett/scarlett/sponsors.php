...
<li>
<?php 
	$ban1 = get_option('scar_banner1'); 
	$url1 = get_option('scar_url1'); 
	?>
...
<li>
<?php 
	$ban2 = get_option('scar_banner2'); 
	$url2 = get_option('scar_url2'); 
	?>
...
<li>
<?php 
	$ban3 = get_option('scar_banner3'); 
	$url3 = get_option('scar_url3'); 
	?>
...
<li>
<?php 
	$ban4 = get_option('scar_banner4'); 
	$url4 = get_option('scar_url4'); 
	?>
