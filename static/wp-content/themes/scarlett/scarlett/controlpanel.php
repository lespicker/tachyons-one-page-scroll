...
$options = array (
	...
	array("name" => "Video embed code",
            ...
            "id" => $shortname."_video",
            "std" => "Enter the video embed code here. Remember to change the size to 320 x 270 in the embed code.",
            "type" => "textarea"),   
	...
	array("name" => "480x60 banner on the header",
			"desc" => "adsense 480 x 60 banner script .",
            "id" => $shortname."_ad1",
            "std" => "",
            "type" => "textarea"),  
			
   	array("name" => "300x250 banner on the posts",
			"desc" => "adsense 300 x 250 banner script .",
            "id" => $shortname."_ad2",
            "std" => "",
            "type" => "textarea"),   
   
	   	array("name" => "728x15 banner on the home page",
			"desc" => "adsense 728 x 15 banner script .",
            "id" => $shortname."_ad3",
            "std" => "",
            "type" => "textarea"),   		
