...
$number_entries = array("Select a Number:","1","2","3","4" );
$options = array (
...
<tr align="left"> 
    ...
    <td>
        <input name="<?php echo $value['id']; ?>" id="<?php echo $value['id']; ?>" type="<?php echo $value['type']; ?>" value="<?php if ( get_settings( $value['id'] ) != "") { echo get_settings( $value['id'] ); } else { echo $value['std']; } ?>" size="20" />
...
<iframe src="../?preview=true" width="90%" height="600" ></iframe>
