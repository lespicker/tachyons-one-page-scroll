...
<?php if ( have_comments() ) : ?>
	<ul class="commentlist">
		<?php wp_list_comments(array('callback' => 'wpjunction_comment')); ?>
	</ul>
		...
		<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
			...
			<?php else : ?>
				...
				<p>
					...
					<small>(required. But it will not be published)</small>
				</p>
			...
			<p class="last"><input name="submit" type="submit" id="submit" tabindex="5" value="Submit" />
